...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        categoryScndAdapater = new CategoryScndAdapater(getActivity(), secondData);
        ...
        categoryThirdAdapater = new CategoryThirdAdapater(getActivity(), thirdData);
        ...
        categoryFourthAdapater = new CategoryFourthAdapater(getActivity(), fourthData);
        rvCategoryFourth.setLayoutManager(new GridLayoutManager(getActivity(), 4));
    ...
    public void onResume() {
        super.onResume();
        categoryFirstAdapater = new CategoryFirstAdapater(getActivity());
